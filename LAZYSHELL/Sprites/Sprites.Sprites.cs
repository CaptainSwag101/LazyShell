    ...
    public partial class Sprites
    {
        ...
        private void frameMold_ValueChanged(object sender, EventArgs e)
        {
            ...
            if (frameMold.Value >= animations[currentAnimation].Molds.Count)
            {
                ...
                MessageBox.Show("Mold for frame #" + currentFrame.ToString() + " is not valid. Change to lower value.", "LAZY SHELL");
                return;
            }
        ...
        private void insertSequence_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(
                    "Could not insert a new sequence.\n\nSprites cannot contain more than 16 sequences total.", "LAZY SHELL",
        ...
        private void insertMold_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(
                    "Could not insert a new mold.\n\nSprites cannot contain more than 32 molds total.", "LAZY SHELL",
                    MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
        ...
        private void insertTile_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(
                    "Could not insert a new tile.\n\nMolds cannot contain more than 32 tiles total.", "LAZY SHELL",
                    MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
        ...
        private void moldTileCopiesOffset_ValueChanged(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("This copy packet offset is bad. Change it to another value.", "LAZY SHELL");
                SetMoldImage();
            }
        }
