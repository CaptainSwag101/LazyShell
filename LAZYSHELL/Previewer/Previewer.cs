...
namespace LAZYSHELL.Previewer
{
    public partial class Previewer : Form
    {
        ...
        private void SetEvent(byte[] eventData, int eventNum)
        {
            ...
            LAZYSHELL.ScriptsEditor.ScriptsModel scriptsModel = model.ScriptsModel;

            LAZYSHELL.ScriptsEditor.EventScript es = new LAZYSHELL.ScriptsEditor.EventScript(this.model.Data, eventData, eventNum);
            LAZYSHELL.ScriptsEditor.EventScript backup = scriptsModel.EventScripts[eventNum];
        ...
        private void PrepareBattlePack(int formationNum)
        {
            ...
            LAZYSHELL.StatsEditor.Stats.FormationPack sfp = statsModel.FormationPacks[0];
