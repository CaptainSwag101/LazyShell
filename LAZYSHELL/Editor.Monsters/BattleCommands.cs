...
namespace LAZYSHELL.ScriptsEditor.Commands
{
    ...
    {
        public BattleCommandE2(byte[] commandData)
            : base(commandData)
        {
            this.length = 2;
        ...
        public override string ToString()
        {
            return "Set target:  " + Lists.TargetNames[commandData[1]];
        }
    ...
    {
        public BattleCommandE5(byte[] commandData)
            : base(commandData)
        {
            this.length = 2;
            this.option = commandData[1];
        ...
        public override string ToString()
        {
            return "Run battle event:  " + Lists.Numerize(Lists.BattleEventNames, commandData[1]);
        }
    ...
    {
        public BattleCommandEB(byte[] commandData)
            : base(commandData)
        {
            this.length = 3;
            this.option = commandData[1];
        ...
        public override string ToString()
        {
            if (option == 0) return "Set invincibility for target:  " + Lists.TargetNames[commandData[2]];
            else return "Null invincibility for target:  " + Lists.TargetNames[commandData[2]];
        }
    ...
    {
        public BattleCommandEA(byte[] commandData)
            : base(commandData)
        {
            this.length = 4;
            this.option = commandData[1];
        ...
        public override string ToString()
        {
            switch (option)
            {
                case 0: return "Remove target from battle:  " + Lists.TargetNames[commandData[3]];
                case 1: return "Call target to battle:  " + Lists.TargetNames[commandData[3]];
                default: return "ERROR";
            }
        }
    ...
    public class BattleCommandFC : BattleScriptCommand
    {
        ...
        * 
        */
        public BattleCommandFC(byte[] commandData, DDlistName spellNames, DDlistName itemNames)
            : base(commandData)
        {
            this.length = 4;
            this.option = commandData[1];
        ...
        public override string ToString()
        {
            ...
            switch (option)
            {
                ...
                case 5:
                    return "If attacked";
                case 6:
                    return "If target:  " + Lists.TargetNames[commandData[2]] + " ,  " + "HP is below:  " + (commandData[3] * 16).ToString();
                case 7:
                ...
                case 8:
                    ...
                    return "If target:  " +
                    Lists.TargetNames[commandData[2]] +
                ...
                case 16:
                    if (commandData[2] == 0) return "If target is alive:  " + Lists.TargetNames[commandData[3]];
                    else if (commandData[2] == 1) return "If target is dead:  " + Lists.TargetNames[commandData[3]];
                    else return "ERROR";
                case 17:
                    for (int i = 0x01, j = 0; i < 0x81; i *= 2, j++)
                    {
