...
namespace LAZYSHELL
{
    public class PhysicalTile
    {
        ...
        public PhysicalTile(byte[] data, int index)
        {
            this.data = data;
            this.index = index;
        ...
        public int[] DrawPhysicalTile(SolidTilePixels solids)
        {
            int[] qBaseOrig = solids.QuadBasePixels;
            int[] qBlockOrig = solids.QuadBlockPixels;
            int[] hqBlockOrig = solids.HalfQuadBlockPixels;
            int[] stULLoOrig = solids.StairsUpLeftLowPixels;
            int[] stULHiOrig = solids.StairsUpLeftHighPixels;
            int[] stURLoOrig = solids.StairsUpRightLowPixels;
            int[] stURHiOrig = solids.StairsUpRightHighPixels;
