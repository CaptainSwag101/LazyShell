...
namespace LAZYSHELL.Compression
{
    public class LSCompression
    {
        ...
        public int Compress(byte[] source, int offset)
        {
            ...
            Bits.SetByteArray(this.data.Buffer, offset, this.worker.Buffer, 0, this.worker.Used);
        ...
        public int Compress(byte[] source, byte[] dest, int offset)
        {
            ...
            Bits.SetByteArray(dest, offset, this.worker.Buffer, 0, this.worker.Used);
        ...
        private void CompressFrame(StreamBuf buf)
        {
            ...
            if (nextFrameSize > 0)
            {
                this.worker.AppendArray(Bits.GetByteArray(this.optimalResult.Buffer, 0, this.optimalResult.Used));
        ...
        private int Case_15_Complete(StreamBuf buf)
        {
            ...
            return 1; // Not accurate, but doesnt matter any more, were done
        }
        /**
