...
namespace LAZYSHELL
{
    ...
    public class LevelLayer
    {
        ...
        private void InitializeLevel(byte[] data)
        {
            ...
            int offset = (levelNum * 18) + 0x1D0040; offset++;
            ...
            maskLowY = (byte)(BitManager.GetByte(data, offset) & 0x3F); offset++;
            maskHighX = (byte)(BitManager.GetByte(data, offset) & 0x3F); offset++;
            maskHighY = (byte)(BitManager.GetByte(data, offset) & 0x3F); offset++;

            leftShiftL2 = BitManager.GetByte(data, offset); offset++;
            upShiftL2 = BitManager.GetByte(data, offset); offset++;
            leftShiftL3 = BitManager.GetByte(data, offset); offset++;
        ...
        public void Assemble()
        {
            ...
            offset = (levelNum * 18) + 0x1D0040; offset++;

            data[offset] = messageBox != 0 ? (byte)((messageBox - 1) << 1) : (byte)0xFE;

            offset++;

            BitManager.SetByte(data, offset, maskLowX);
            BitManager.SetBit(data, offset, 7, maskLock); offset++;
            BitManager.SetByte(data, offset, maskLowY); offset++;
            BitManager.SetByte(data, offset, maskHighX); offset++;
            BitManager.SetByte(data, offset, maskHighY); offset++;

            BitManager.SetByte(data, offset, leftShiftL2); offset++;
            BitManager.SetByte(data, offset, upShiftL2); offset++;
            BitManager.SetByte(data, offset, leftShiftL3); offset++;
            BitManager.SetByte(data, offset, upShiftL3);
            BitManager.SetBit(data, offset, 7, infiniteAutoscroll); offset++;

            BitManager.SetBit(data, offset, 0, horizontalScrollWrapL1);
            BitManager.SetBit(data, offset, 1, verticalScrollWrapL1);
            BitManager.SetBit(data, offset, 2, culexA);
            BitManager.SetBit(data, offset, 3, horizontalScrollWrapL2);
            BitManager.SetBit(data, offset, 4, verticalScrollWrapL2);
            BitManager.SetBit(data, offset, 5, culexB);
            BitManager.SetBit(data, offset, 6, horizontalScrollWrapL3);
            BitManager.SetBit(data, offset, 7, verticalScrollWrapL3);

            offset++;

            BitManager.SetByte(data, offset, 0);
            switch (horizontalSyncL2)
            {
                case 0: BitManager.SetBitsByByte(data, offset, 0x03, false); break;
                case 1: BitManager.SetBitsByByte(data, offset, 0x02, true); break;
                case 2: BitManager.SetBitsByByte(data, offset, 0x03, true); break;
                case 3: BitManager.SetBitsByByte(data, offset, 0x01, true); break;
            }
            switch (verticalSyncL2)
            {
                case 0: BitManager.SetBitsByByte(data, offset, 0x0C, false); break;
                case 1: BitManager.SetBitsByByte(data, offset, 0x08, true); break;
                case 2: BitManager.SetBitsByByte(data, offset, 0x0C, true); break;
                case 3: BitManager.SetBitsByByte(data, offset, 0x04, true); break;
            }
            switch (horizontalSyncL3)
            {
                case 0: BitManager.SetBitsByByte(data, offset, 0x30, false); break;
                case 1: BitManager.SetBitsByByte(data, offset, 0x20, true); break;
                case 2: BitManager.SetBitsByByte(data, offset, 0x30, true); break;
                case 3: BitManager.SetBitsByByte(data, offset, 0x10, true); break;
            }
            switch (verticalSyncL3)
            {
                case 0: BitManager.SetBitsByByte(data, offset, 0xC0, false); break;
                case 1: BitManager.SetBitsByByte(data, offset, 0x80, true); break;
                case 2: BitManager.SetBitsByByte(data, offset, 0xC0, true); break;
                case 3: BitManager.SetBitsByByte(data, offset, 0x40, true); break;
            }
            ...
            switch (scrollDirectionL2)
            {
                ...
                case 1: BitManager.SetByte(data, offset, 0x08); break;
                case 2: BitManager.SetByte(data, offset, 0x10); break;
                case 3: BitManager.SetByte(data, offset, 0x18); break;
                case 4: BitManager.SetByte(data, offset, 0x20); break;
                case 5: BitManager.SetByte(data, offset, 0x28); break;
                case 6: BitManager.SetByte(data, offset, 0x30); break;
                case 7: BitManager.SetByte(data, offset, 0x38); break;
            }

            switch (scrollSpeedL2)
            {
                case 0: BitManager.SetBitsByByte(data, offset, 0x00, true); break;
                case 4: BitManager.SetBitsByByte(data, offset, 0x01, true); break;
                case 2: BitManager.SetBitsByByte(data, offset, 0x02, true); break;
                case 1: BitManager.SetBitsByByte(data, offset, 0x03, true); break;
                case 3: BitManager.SetBitsByByte(data, offset, 0x04, true); break;
                case 5: BitManager.SetBitsByByte(data, offset, 0x05, true); break;
                case 6: BitManager.SetBitsByByte(data, offset, 0x07, true); break;
            }

            BitManager.SetBit(data, offset, 7, scrollL2Bit7);
            offset++;
            ...
            BitManager.SetBit(data, offset, 7, scrollL3Bit7);
            offset++;

            BitManager.SetByte(data, offset, 0);
            BitManager.SetBit(data, offset, 4, waveEffectL3);
            BitManager.SetBitsByByte(data, offset, layerPrioritySet, true);
            ...
            switch (animationEffectL3)
            {
                ...
                case 7: BitManager.SetByte(data, offset, 0x08); break;
                case 8: BitManager.SetByte(data, offset, 0x09); break;
                case 9: BitManager.SetByte(data, offset, 0x0A); break;
                case 10: BitManager.SetByte(data, offset, 0x0B); break;
                case 11: BitManager.SetByte(data, offset, 0x0C); break;
                case 12: BitManager.SetByte(data, offset, 0x0D); break;
                case 13: BitManager.SetByte(data, offset, 0x0E); break;
                case 14: BitManager.SetByte(data, offset, 0x0F); break;
                case 15: BitManager.SetByte(data, offset, 0x10); break;
                case 16: BitManager.SetByte(data, offset, 0x11); break;
                case 17: BitManager.SetByte(data, offset, 0x12); break;
                case 18: BitManager.SetByte(data, offset, 0x14); break;
                case 19: BitManager.SetByte(data, offset, 0x15); break;
                case 20: BitManager.SetByte(data, offset, 0x16); break;
                case 21: BitManager.SetByte(data, offset, 0x17); break;
                case 22: BitManager.SetByte(data, offset, 0x18); break;
            }
            ...
            {
                case 0: BitManager.SetByte(data, offset, 0x00); break;
                case 1: BitManager.SetByte(data, offset, 0x05); break;
                case 2: BitManager.SetByte(data, offset, 0x06); break;
                case 3: BitManager.SetByte(data, offset, 0x07); break;
                case 4: BitManager.SetByte(data, offset, 0x0A); break;
                case 5: BitManager.SetByte(data, offset, 0x0B); break;
                case 6: BitManager.SetByte(data, offset, 0x0C); break;
                case 7: BitManager.SetByte(data, offset, 0x0D); break;
                case 8: BitManager.SetByte(data, offset, 0x0F); break;
                case 9: BitManager.SetByte(data, offset, 0x10); break;
                case 10: BitManager.SetByte(data, offset, 0x12); break;
                case 11: BitManager.SetByte(data, offset, 0x13); break;
                case 12: BitManager.SetByte(data, offset, 0x15); break;
                case 13: BitManager.SetByte(data, offset, 0x16); break;
                case 14: BitManager.SetByte(data, offset, 0x17); break;
                case 15: BitManager.SetByte(data, offset, 0x18); break;
                case 16: BitManager.SetByte(data, offset, 0x19); break;
                case 17: BitManager.SetByte(data, offset, 0x1A); break;
                case 18: BitManager.SetByte(data, offset, 0x1B); break;
                case 19: BitManager.SetByte(data, offset, 0x1D); break;
                case 20: BitManager.SetByte(data, offset, 0x1E); break;
                case 21: BitManager.SetByte(data, offset, 0x1F); break;
                case 22: BitManager.SetByte(data, offset, 0x20); break;
                case 23: BitManager.SetByte(data, offset, 0x21); break;
                case 24: BitManager.SetByte(data, offset, 0x22); break;
            }
        }
        public void Clear()
        {
