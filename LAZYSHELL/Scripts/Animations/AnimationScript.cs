...
namespace LAZYSHELL.ScriptsEditor
{
    public class AnimationScript
    {
        ...
        private int animationNum; public int AnimationNum { get { return this.animationNum; } set { this.animationNum = value; } }
        ...
        public AnimationScript(byte[] data, int animationNum, int type)
        {
            this.data = data;
            this.animationNum = animationNum;
            this.type = type;

            InitializeAnimationScript(animationNum, type);
        }
        private void InitializeAnimationScript(int animationNum, int type)
        {
            ...
            if (type == 0)
                ...
                baseOffset = bank + BitManager.GetShort(data, bank + start + animationNum * 2);
        ...
        private void ParseAnimationScript(byte[] data)
        {
            ...
            {
                offset = baseOffset + 2;
                if (animationNum == 22) offset = baseOffset + 4;
                if (animationNum == 70) offset = baseOffset + 6;
                if (animationNum == 85) offset = baseOffset + 6;
            }
            ...
            while (offset < data.Length)
            {
                ...
                temp = new AnimationScriptCommand(data, BitManager.GetByteArray(data, offset, len), offset, this, null);
        ...
        {
            this.commands = null;
            InitializeAnimationScript(this.animationNum, this.type);
        }
