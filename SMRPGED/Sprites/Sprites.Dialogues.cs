    ...
    public partial class Sprites
    {
        ...
        private void AssembleDialogues()
        {
            ...
            if (DialogueFreeSpace(0))
            {
                ...
                MessageBox.Show("WARNING: The dialogue in bank 1 was not saved. Please delete the necessary number of bytes for space.\nLast dialogue saved was #" + i.ToString() + ". It should have been #2047");
            ...
            if (DialogueFreeSpace(0x800))
            {
                ...
                MessageBox.Show("WARNING: The dialogue in bank 2 was not saved. Please delete the necessary number of bytes for space.\nLast dialogue saved was #" + i.ToString() + ". It should have been #2047");
            ...
            if (DialogueFreeSpace(0xC00))
            {
                ...
                MessageBox.Show("WARNING: The dialogue in bank 3 was not saved. Please delete the necessary number of bytes for space.\nLast dialogue saved was #" + i.ToString() + ". It should have been #2047");
        }
                    ...
                    if (currentDialogue < 0x800)
                    {
                        for (int i = 0; i < 0x800; i++)
                        {
                            if (universal.Dialogues[i].DuplicateDialogues == currentDialogue)
                            {
                                ...
                                //    "WARNING: This dialogue is used as an auxiliary dialogue for 1 or more other dialogues.\n" +
                                //    "That means that those 1 or more other dialogues are essentially duplicates of this\n" +
                                //    "dialogue, ie. they point to the same location in the bank.\n\n" +
                                //    "Thus, modifying this dialogue may result in a significant loss of free space,\n" +
                                //    "depending on how many other dialogues it is an auxiliary dialogue for.\n\n" +
                                //    "Are you sure you want to change it?",
                                //    "MODIFY DIALOGUE?", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
                                //if (result == DialogResult.Cancel)
                                //{
                                //    universal.Dialogues[currentDialogue].DuplicateDialogues = temp;
