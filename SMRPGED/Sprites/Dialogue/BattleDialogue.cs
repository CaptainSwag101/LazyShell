...
namespace SMRPGED
{
    public class BattleDialogue
    {
        ...
        public string GetBattleDialogue(bool symbols) { if (!error) return new string(textHelperReduced.DecodeText(battleDialogue, symbols)); else return new string(battleDialogue); }
