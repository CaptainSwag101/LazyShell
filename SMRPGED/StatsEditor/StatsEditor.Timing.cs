...
namespace SMRPGED.StatsEditor
{
    public partial class StatsEditor
    {
        ...
        private void InitializeTimingStrings()
        {
            ...
            for (int i = 0; i < 37; i++)
                this.weaponName.Items.Add(statsModel.Items[i].Name);
        ...
        private void weaponName_DrawItem(object sender, DrawItemEventArgs e)
        {
            ...
            char[] arr = new char[statsModel.Items[e.Index].Name.Length + 1];
            arr[0] = (char)statsModel.Items[e.Index].Icon;
            for (int i = 1; i < arr.Length; i++)
            {
                arr[i] = (char)statsModel.Items[e.Index].Name[i - 1];
        ...
        private void level1TimingSpellName_DrawItem(object sender, DrawItemEventArgs e)
        {
            ...
            char[] arr = statsModel.Spells[spellsToFind[e.Index]].Name.ToCharArray();
