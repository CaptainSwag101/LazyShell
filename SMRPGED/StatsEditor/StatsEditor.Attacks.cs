    ...
    public partial class StatsEditor
    {
        ...
        private void RefreshAttackTab()
        {
            if (!updatingAttacks)
            {
                ...
                this.textBoxAttackName.Text = statsModel.Attacks[(int)attackNum.Value].Name;
        ...
        private void attackName_DrawItem(object sender, DrawItemEventArgs e)
        {
            ...
            char[] arr = statsModel.Attacks[universal.AttackNames.GetNumFromIndex(e.Index)].Name.ToCharArray();
            ...
            // set the pixels
            int[] temp = battleDialoguePreview.GetPreview(fontCharacters, palette, arr, false);
        ...
        private void textBoxAttackName_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                statsModel.Attacks[(int)attackNum.Value].Name = this.textBoxAttackName.Text;

                universal.AttackNames.SwapName(statsModel.Attacks[(int)attackNum.Value].AttackNum, statsModel.Attacks[(int)attackNum.Value].Name);
                universal.AttackNames.SortAlpha();
                this.attackName.Items.Clear();
