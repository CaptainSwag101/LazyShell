            ...
            try
            {
                ...
                if (!actionScript)
                {
                    ...
                    if (esc.Option < 0xF0)
                    {
                        ...
                        {
                            MessageBox.Show(
                                "Cannot insert any more action queue commands to the queue trigger.",
                    ...
                    foreach (TreeNode child in tn.Nodes)
                    {
                        ...
                        if (tnChecked)
                        {
                            MessageBox.Show(
                                ...
                                "WARNING: CANNOT COPY COMMAND(S)", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                            eventCopies = null;
                            return;
                        }
                ...
                catch
                {
                    ...
                    else
                    {
                        MessageBox.Show(
                            ...
                            "CANNOT PASTE COMMAND(S)", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        return;
                    }
                }
            }
