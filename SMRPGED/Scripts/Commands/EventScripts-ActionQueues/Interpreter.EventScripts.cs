            ...
            switch (esc.Opcode)
            {
                case 0x32:
                    sb.Append(ObjectNames[esc.Option] +
                        ", jump to $" + BitManager.GetShort(esc.EventData, 2).ToString("X4"));
                    break;
                case 0x34:
                case 0x35:
                ...
                case 0x38:
                    ...
                    break;
                case 0x39:
                    sb.Append(ObjectNames[esc.Option] + ", jump to $" + BitManager.GetShort(esc.EventData, 2).ToString("X4"));
                    break;
                case 0x3A:
                    sb.Append(ObjectNames[esc.Option] +
                        ...
                        "), jump to $" + BitManager.GetShort(esc.EventData, 5).ToString("X4"));
                    break;
                case 0x3B:
                    sb.Append(ObjectNames[esc.Option] +
                        " and obj: " + ObjectNames[esc.EventData[2]] +
                ...
                case 0x3E:
                    sb.Append(esc.Option.ToString() +
                        ...
                        ", if obj null jump to $" + BitManager.GetShort(esc.EventData, 3).ToString("X4"));
                    break;
                case 0x3F:
                    sb.Append(esc.Option.ToString() +
                        ", @ coords of Mario, if Mario null jump to $" + BitManager.GetShort(esc.EventData, 2).ToString("X4"));
                    break;
                case 0x42:
                    sb.Append(BitManager.GetShort(esc.EventData, 1).ToString("X4") +
                        ", else jump to $" + BitManager.GetShort(esc.EventData, 3).ToString("X4"));
                    break;
                case 0x40:
                    sb.Append((BitManager.GetShort(esc.EventData, 1) & 0xFFF).ToString() + ", stop if exit level = ");
                    sb.Append(((esc.EventData[2] & 0x20) == 0x20) ? "true" : "false");
                    break;
                case 0xD0:
                case 0xD1:
                    sb.Append((BitManager.GetShort(esc.EventData, 1) & 0xFFF).ToString());
                    break;
                case 0x4B:
                case 0x4C:
                case 0x4F:
                ...
                case 0x50:
                case 0x51:
                    sb.Append("[" + esc.Option.ToString() + "] \"" + TrimTailSpaces(universal.ItemNames.GetNameByNum(esc.Option)) + "\"");
                    break;
                case 0x54:
                    sb.Append(CharacterNames[esc.Option] +
                        ", with item: [" + esc.EventData[2] + "] \"" + TrimTailSpaces(universal.ItemNames.GetNameByNum(esc.EventData[2])) + "\"");
                    break;
                case 0x4E:
                    switch (esc.Option)
                    {
                        case 2: a = ""; break;
                        case 3: a = ""; break;
                        case 5: a = ": toss item: " + universal.ItemNames.GetNameByNum(esc.EventData[2]); break;
                ...
                case 0x60:
                    ...
                    sb.Append("[" + (BitManager.GetShort(esc.EventData, 1) & 0xFFF).ToString() + "] \"" +
                        universal.Dialogues[BitManager.GetShort(esc.EventData, 1) & 0xFFF].GetDialogueStub(true) + "\"" +
                        a + b + c + d +
                ...
                case 0x68:
                    ...
                    break;
                case 0x6A:
                    sb.Append((BitManager.GetShort(esc.EventData, 1) & 0x1FF).ToString());
                    break;
                case 0x6B:
                    sb.Append((BitManager.GetShort(esc.EventData, 1) & 0x1FF).ToString());
                    break;
                ...
                case 0xC0:
                case 0xF1:
                    sb.Append(BitManager.GetShort(esc.EventData, 1).ToString());
                    break;
                case 0xB0:
                    sb.Append(((esc.Option * 2) + 0x7000).ToString("X4") +
                        " = " + BitManager.GetShort(esc.EventData, 2).ToString());
                    break;
                case 0xB1:
                    sb.Append(((esc.Option * 2) + 0x7000).ToString("X4") +
                        " += " + BitManager.GetShort(esc.EventData, 2).ToString());
                ...
                case 0xB7:
                    sb.Append(((esc.Option * 2) + 0x7000).ToString("X4") +
                        " = random # < " + BitManager.GetShort(esc.EventData, 2).ToString());
                    break;
                case 0xB8:
                case 0xB9:
                case 0xBA:
                ...
                case 0xDA:
                    sb.Append((((((esc.Opcode * 0x100) + esc.Option) - 0xD800) / 8) + 0x7040).ToString("X4") + ", bit: " +
                        ...
                        (BitManager.GetShort(esc.EventData, 2)).ToString("X4"));
                    break;
                case 0xDC:
                case 0xDD:
                case 0xDE:
                ...
                case 0xE0:
                    sb.Append((esc.Option + 0x70A0).ToString("X4") + " = " +
                        ...
                        (BitManager.GetShort(esc.EventData, 3)).ToString("X4"));
                    break;
                case 0xE1:
                    sb.Append((esc.Option + 0x70A0).ToString("X4") + " != " +
                        esc.EventData[2].ToString() + ", jump to $" +
                ...
                case 0xE2:
                case 0xE3:
                    sb.Append((BitManager.GetShort(esc.EventData, 1)).ToString() + ", jump to $" +
                    (BitManager.GetShort(esc.EventData, 3)).ToString("X4"));
                    break;
                case 0xE4:
                case 0xE5:
                    sb.Append(((esc.Option * 2) + 0x7000).ToString("X4") + " = " +
                    (BitManager.GetShort(esc.EventData, 2)).ToString() + ", jump to $" +
                    (BitManager.GetShort(esc.EventData, 4)).ToString("X4"));
                    break;
                case 0xE6:
                case 0xE7:
                    sb.Append(BitManager.GetShort(esc.EventData, 1).ToString() + ", jump to $" +
                ...
                case 0xEF:
                    ...
                    break;
                case 0xE9:
                    sb.Append(BitManager.GetShort(esc.EventData, 1).ToString("X4") + ", else jump to $" +
                        BitManager.GetShort(esc.EventData, 3).ToString("X4"));
                    break;
                case 0xF2:
            ...
            switch (esc.Option)
            {
                ...
                case 0x3E:
                    sb.Append(esc.EventData[2].ToString() +
                        ", assign event #" + BitManager.GetShort(esc.EventData, 3).ToString("X4") +
                        ", jump to $" + BitManager.GetShort(esc.EventData, 5).ToString("X4"));
                    break;
                case 0x4C:
                case 0x4D:
                ...
                case 0xAA:
                    ...
                    break;
                case 0xAC:
                    sb.Append((BitManager.GetShort(esc.EventData, 2) + 0xF800).ToString("X4"));
                    break;
                case 0xB0:
                case 0xB1:
                case 0xB2:
                    sb.Append(BitManager.GetShort(esc.EventData, 2).ToString());
                    break;
                case 0xB3:
                case 0xB4:
                case 0xB5:
