...
namespace SMRPGED.ScriptsEditor.Commands
{
    ...
    public class EventScriptCommand : EventActionCommand
    {
            ...
            if (eventData.Length >= 2)
            {
                if (eventData[0] >= 0 && eventData[0] <= 0x2F && eventData[1] <= 0xF1)
                {
                    if (eventData[1] == 0xF0 || eventData[1] == 0xF1)
                        embeddedActionQueue = new ActionQueue(BitManager.GetByteArray(eventData, 3, eventData.Length - 3), -1, offset + 3);
                    else
                        embeddedActionQueue = new ActionQueue(BitManager.GetByteArray(eventData, 2, eventData.Length - 2), -1, offset + 2);
                }
            }
        }
        ...
        {
            BitManager.SetBit(eventData, byteToSet, bitToSet, bit);
        }
        ...
        public override void WritePointerSpecial(int index, ushort write)
        {
            ...
            if (index == 0)
                BitManager.SetShort(eventData, 1, write);
            else if (index == 1)
                BitManager.SetShort(eventData, 3, write);
        }
        public override ushort ReadPointerSpecial(int index)
        {
            if (eventData[0] != 0xE9 && eventData[0] != 0x42 && eventData[0] != 0x67)
                throw new Exception("Not Command 0xE9, 0x42 or 0x67");
            if (index == 0)
                return BitManager.GetShort(eventData, 1);
            else if (index == 1)
                return BitManager.GetShort(eventData, 3);
            return 0;
        }
        public override ushort ReadPointer()
        {
            switch (eventData[0])
            {
                ...
                case 0xDD:
                case 0xDE:
                    return BitManager.GetShort(eventData, 2);
                case 0x3E:  // 3
                case 0xE0:
                case 0xE1:
                case 0xE2:
                ...
                case 0xE4:
                case 0xE5:
                    return BitManager.GetShort(eventData, 4);
                case 0x3A:  // 5
                case 0x3B:
                    return BitManager.GetShort(eventData, 5);
                case 0x42:  // 1,3
                case 0x67:
                case 0xE9:
        ...
        public override void WritePointer(ushort pointer)
        {
            switch (eventData[0])
            {
                ...
                case 0xEE:
                case 0xEF:
                    BitManager.SetShort(eventData, 1, pointer); break;
                case 0x32:  // 2
                case 0x39:
                case 0x3F:
                case 0xD8:
                ...
                case 0xDD:
                case 0xDE:
                    BitManager.SetShort(eventData, 2, pointer); break;
                case 0x3E:  // 3
                case 0xE0:
                case 0xE1:
                case 0xE2:
                ...
                case 0xE7:
                case 0xF8:
                    BitManager.SetShort(eventData, 3, pointer); break;
                case 0x3C:  // 4
                case 0xE4:
                case 0xE5:
                    BitManager.SetShort(eventData, 4, pointer); break;
                case 0x3A:  // 5
                case 0x3B:
                    BitManager.SetShort(eventData, 5, pointer); break;
                case 0x42:  // 1,3
                case 0x67:
                case 0xE9:
                    throw new Exception("E9");
