            ...
            switch (Opcode)
            {
                ...
                case 0x09:
                    ...
                    if (parent == null && !SearchForOffset(animationScript, search))
                        InitializeAnimationScript((offset & 0xFF0000) + BitManager.GetShort(animationData, 1));
                ...
                case 0x68:
                    ...
                    if ((offset & 0xFF0000) == 0x350000 && BitManager.GetShort(animationData, 1) == 0x8499)
                        animationScript.AMem = 0;
                    if (offset == 0x3AA5EE)
                    ...
                    break;
                case 0x5D:
                    InitializeAnimationScript((offset & 0xFF0000) + BitManager.GetShort(animationData, 3));
                    break;
                ...
                default:
                    ...
                    {
                        search = (offset & 0xFF0000) + BitManager.GetShort(animationData, 4);
                        if (parent == null && !SearchForOffset(animationScript, search))
                            InitializeAnimationScript((offset & 0xFF0000) + BitManager.GetShort(animationData, 4));
                        else if (parent != null && !parent.SearchForOffset(parent, search))
                            InitializeAnimationScript((offset & 0xFF0000) + BitManager.GetShort(animationData, 4));
                    }
                    break;
            ...
            switch (Opcode)
            {
                case 0x09:
                    while ((offset & 0xFFFF) < 0xFFFF)
                    {
                        ...
                        temp = new AnimationScriptCommand(data, BitManager.GetByteArray(data, offset, len), offset, animationScript, this);
                        commands.Add(temp);
                ...
                case 0x64:
                    if (animationScript.AMem > 0x10)
                    {
                        ...
                        offset = (offset & 0xFF0000) + BitManager.GetShort(data, offset + (animationScript.AMem * 2));
                    goto case 0x09;
                case 0x68:
                    ...
                    if (offset == 0x356919 ||
                        ...
                        offset = (offset & 0xFF0000) + BitManager.GetShort(data, offset + animationData[3]);
                    goto case 0x09;
                default:
                    if (Opcode >= 0x24 && Opcode <= 0x2B)
                    {
                        offset = (offset & 0xFF0000) + BitManager.GetShort(animationData, 4);
                        goto case 0x09;
                    }
                    break;
            }
