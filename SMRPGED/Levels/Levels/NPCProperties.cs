...
namespace SMRPGED
{
    public class NPCProperties
    {
        ...
        private int npcNum; public int NPCNum { get { return npcNum; } set { npcNum = value; } }
        ...
        public NPCProperties(byte[] data, int npcNum)
        {
            this.data = data;
            this.npcNum = npcNum;
            InitializeNPC(data);
        ...
        {
            int offset = npcNum * 7 + 0x1DB800;

            ushort temp = 0;

            temp = BitManager.GetShort(data, offset);
            offset++;
        ...
        public void Assemble()
        {
            ...
            BitManager.SetShort(data, offset, sprite);offset++;
            BitManager.SetBit(data, offset, 2, b1b2);
            BitManager.SetBit(data, offset, 3, b1b3);
            BitManager.SetBit(data, offset, 4, b1b4);
            BitManager.SetBit(data, offset, 5, b1b5);
            BitManager.SetBit(data, offset, 6, b1b6);
            BitManager.SetBit(data, offset, 7, b1b7);
            offset++;

            BitManager.SetBit(data, offset, 5, priority0);
            BitManager.SetBit(data, offset, 6, priority1);
            BitManager.SetBit(data, offset, 7, priority2);
            BitManager.SetBit(data, offset, 0, b2b0);
            BitManager.SetBit(data, offset, 1, b2b1);
            BitManager.SetBit(data, offset, 2, b2b2);
            ...
            data[offset] = height;
            BitManager.SetBit(data, offset, 5, b5b5);
            BitManager.SetBit(data, offset, 6, b5b6);
            BitManager.SetBit(data, offset, 7, b5b7);
            offset++;

            BitManager.SetBit(data, offset, 2, b6b2);
        }
        public int[] CreateImage(int radialPosition, bool fromSprite, int fromSpriteNum)
        {
            ...
            offset = BitManager.GetShort(sm, 2);
