    ...
    public partial class Notes : Form
    {
        ...
        public Notes(Model model)
        {
            ...
            if (settings.LoadNotes)
            {
                ...
                {
                    MessageBox.Show("Error loading last used database. The file has been moved or no longer exists.",
        ...
        private void buttonLoad_Click(object sender, EventArgs e)
        {
            ...
            if (elementType.SelectedIndex == 9)
            {
            ...
            if (elementType.SelectedIndex == 14)
            {
        ...
        private void buttonBrowse_Click(object sender, EventArgs e)
        {
            if (notes != null)
            {
                DialogResult result = MessageBox.Show("Save changes to current notes?", "LAZY SHELL",
                    MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
                if (result == DialogResult.Yes)
                    SaveLoadedNotes();
                if (result == DialogResult.Cancel)
        ...
        private bool CreateNewNotes()
        {
            if (notes != null)
            {
                DialogResult result = MessageBox.Show("Save changes to current notes?",
